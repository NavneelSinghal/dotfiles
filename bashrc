...
# shell alias to avoid bad PS1
# alias sh="PS1='$\u@\h:\w\$ ' sh"
alias sh="PS1='\$0\$ ' sh"

#alias for opening a file
alias open='gio open'

#alias for changing brightness - 0 is 0 and 1 is 100%
alias brightness='xrandr --output eDP-1-1 --brightness'

#alias for switching between paper mode and screen mode
alias paper='xcalib -clear && xcalib -red 1.1 1 60 -green 1.1 1 60 -blue 1.1 1 60 -alter'
alias screen='xcalib -clear'

#alias for random folder
...
LD_LIBRARY_PATH=~/Desktop/Summer/rose/install/lib/
